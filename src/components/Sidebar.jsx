  ...
  return (
    <div className="h-full p-2 flex flex-col bg-white w-[280px]  border-r border-gray-200 ">
        ...
        >
          ...
          >
            <div className="flex flex-col items-center text-white text-center">
              ...
              <p className="text-[12px] text-gray-400">pk85764798@gmail.com</p>
            </div>
      ...
      <div className="">
        ...
        <div className=" text-[12px]">
          <button className="w-full relative group flex items-center gap-2 px-3 py-2 hover:bg-gray-50 rounded-lg">
