...
export default function TrashPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-white text-gray-800 px-4 md:px-8 py-4">
      {/* Top Bar */}
      <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-gray-200 pb-2 gap-3 sm:gap-0">
        {/* Tabs Section */}
